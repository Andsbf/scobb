...
if Rails.env.development?
  ...
  su = Employee.create!(
    ...
    gender: 'female',
    address: "#{[rand(100..9999),''].sample}, #{Faker::Address.postcode}, #{Faker::Address.building_number}, #{Faker::Address.street_address},#{Faker::Address.city}",
  ...
  30.times do |i|
    clients << Client.create!(
      ...
      gender: ['male', 'female'].sample,
      address: "#{rand(100..9999)}, #{Faker::Address.postcode}, #{Faker::Address.building_number}, #{Faker::Address.street_address},#{Faker::Address.city}",
      notes: [Faker::Lorem.sentence, ""].sample,
      password: "123456",
      password_confirmation: "123456"
    )
